...
public:
    ...
    { 
        if (PieceColor == 'W') 
            looks.loadFromFile("Sprites/PawnWhite.png");
        else 
            looks.loadFromFile("Sprites/PawnBlack.png");
        
        sprite.setTexture(looks); 
    }
    ~PawnPiece() {}
...
public:
    ...
    {
        if (PieceColor == 'W')
            looks.loadFromFile("Sprites/KnightWhite.png");
        else
            looks.loadFromFile("Sprites/KnightBlack.png");
...
public:
    ...
    {
        if (PieceColor == 'W')
            looks.loadFromFile("Sprites/BishopWhite.png");
        else
            looks.loadFromFile("Sprites/BishopBlack.png");
...
public:
    ...
    {
        if (PieceColor == 'W')
            looks.loadFromFile("Sprites/RookWhite.png");
        else
            looks.loadFromFile("Sprites/RookBlack.png");
...
public:
    ...
    {
        if (PieceColor == 'W')
            looks.loadFromFile("Sprites/QueenWhite.png");
        else
            looks.loadFromFile("Sprites/QueenBlack.png");
...
public:
    ...
    {
        if (PieceColor == 'W')
            looks.loadFromFile("Sprites/KingWhite.png");
        else
            looks.loadFromFile("Sprites/KingBlack.png");
...
public:
    ...
    void draw(RenderWindow& window)
    {
        for (int i = 0; i < 8; i++)
        {
            for (int j = 0; j < 8; j++)
            {
                if (MainGameBoard[i][j] != NULL)
                {
                    MainGameBoard[i][j]->sprite.setPosition(j * 64, i * 64);
                    window.draw(MainGameBoard[i][j]->sprite);
                }
...
public:
    ...
    {
        looks.loadFromFile("Sprites/ChessBoard.png");
        sprite.setTexture(looks);
        sprite.setPosition(0, 0);
        music.openFromFile("Sprites/ChessGameMusic.mp3");
        music.setLoop(true);
    }
    ~ChessBoard() {}
    ...
    void Start() {
        ...
        Mouse ms;
        sprite.setPosition(0, 0);
        bool SelectPiece = 0, SelectDest = 0, Menu = 1;
        Texture BG;
        BG.loadFromFile("Sprites/ChessMenu.png");
        ...
        sprite.setTexture(looks);
            do {
                if (ms.isButtonPressed(ms.Left))
                {
                    if (SelectPiece == 0 && SelectDest == 0)
                    {
                        iStartCol = Mouse::getPosition(window).x / 64;
                        iStartRow = Mouse::getPosition(window).y / 64;
                        cout << "Selected " << iStartRow << " " << iStartCol << endl;
                        SelectPiece = 1;
                        do {} while (ms.isButtonPressed(ms.Left));
                    }
                    else if(SelectPiece == 1 && SelectDest == 0)
                    {
                        iEndCol = Mouse::getPosition(window).x / 64;
                        iEndRow = Mouse::getPosition(window).y / 64;
                        cout << "Selected Dest " << iEndRow << " " << iEndCol << endl;
                        SelectDest = 1;
                        do {} while (ms.isButtonPressed(ms.Left));
                    }

                }
                if (SelectDest && SelectPiece)
                {
                    GetNextMoveGUI(mqGameBoard.MainGameBoard);
    ...
    void GetNextMoveGUI(GamePiece* GameBoard[8][8])
    {
